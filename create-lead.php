 ...
 *
 * NOTICE:
 * We had the issue that SOAP was not installed on our server. Since we were on MediaTemple, we 
 * followed these directions. If you are on a differnt host, you will have to find your own link.
...
define('WEB_APP_NAME', 'MyAwesomeApp.tld'); // This can be anything you want. It will identify any leads in the system as coming from your web app.
...
$salesforce['password'] = 'salesforcepwd';
...
try {
	 ...
	 *
	 * Note #2: Find the full list of available fields here: 
	 * http://www.salesforce.com/us/developer/docs/api/Content/sforce_api_objects_lead.htm
	 * 
	 * Note #3: When checking in Salesforce to see if the leads have been generated, go to 
